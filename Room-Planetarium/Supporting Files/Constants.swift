...
extension Planet {
    static let mercury = Planet(radius: 2.439, surfaceImage: "art.scnassets/mercury.jpg")
    static let venus = Planet(radius: 6.051, surfaceImage: "art.scnassets/venus.jpg")
    static let earth = Planet(radius: 6.371, surfaceImage: "art.scnassets/earth.jpg")
    static let moon = Planet(radius: 1.737, surfaceImage: "art.scnassets/moon.jpg")
...
struct PlanetFacts {
    static let facts: [PlanetType: [String]] = [
        ...
        .venus: [
            ...
            "Soviet probe Venera 7 landed on Venus in 1970.",
        ...
        .earth: [
            ...
            "The Białowieża Forest is Europe's last primeval forest.",
            "Earth's core temperature is hotter than the surface of the Sun.",
            "'Green flashes' can sometimes be seen during sunrises or sunsets.",
        ...
        .mars: [
            ...
            "The Martian day 'sol' is only slightly longer than a day on Earth.",
            ...
            "Mars has the solar system's deepest impact crater, Hellas Basin. 7.152 m.",
